            ...
            <div class="conn">
                ...
                <!-- <form action=""> -->
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="" id=""  placeholder="Tapez ici votre question. Pensez à nous fournir le maximum d'informations détaillées pour que notre réponse soit la plus pertinente possible."></textarea>
                    </div>
                            ...
                            <select name="" id="">
                             ...
                             <div class="blocke">
                                <div class="b">
                                    ...
                                    <div class="d">
                                        <input type="text" placeholder="Entrer votre poids">
                                    </div>
                                    <div class="e">kg</div>
                                </div>
                                 <div class="b">
                                    ...
                                    <div class="d">
                                        <input type="text" placeholder="Entrer votre Taille">
                                    </div>
                                    <div class="e">Cm</div>
                                </div>
                                 <div class="b">
                                    <div class="c">Age</div>
                                    <div class="d">
                                        <input type="text" placeholder="Entrer votre Age">
                                    </div>
                                    <div class="e">Ans</div>
                                </div>
                            </div>
                            <label for="" class="pays">Pays</label>
                            <select name="" id="" class="pays">
                    ...
                    <legend>Traitements Actuels :</legend>
                     <div class="form-group">
                        ...
                        <textarea name="" id="" class="tera" placeholder="Tapez ici vos Traitements "></textarea>
                    ...
                    <legend>Antécédents Médicaux :</legend>
                     <div class="form-group">
                        ...
                        <textarea name="" id="" class="tera" placeholder="Tapez ici vos Antécédents "></textarea>
